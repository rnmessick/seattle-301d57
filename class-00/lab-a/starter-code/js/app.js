...
//allProducts is not a constant variable
let allProducts = [];
...
//totalClicks is not a constant variable
let totalClicks = 0;
const views = [];
const votes = [];
...
function displayPics(){
  ...
  // rando is only scoped to the displayPics function.
  console.log(viewed);
  // is is not a constant variable in this context
  for (let i = 0; i < 3; i++){
